...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--variants",
        default="mode-strict,missing,parent-no-exec,owner-root,file-unreadable,file-unwritable",
        help="Comma-separated permission-drift variants to sample. Supported: mode-strict,missing,parent-no-exec,owner-root,file-unreadable,file-unwritable.",
    )
    parser.add_argument(
        "--artifacts",
        default="",
...
def main() -> int:
    ...
    supported_variants = {"mode-strict", "missing", "parent-no-exec", "owner-root", "file-unreadable", "file-unwritable"}
