...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--variants",
        default="mode-strict,missing",
        help="Comma-separated permission-drift variants to sample. Supported: mode-strict,missing.",
    )
    parser.add_argument(
        "--artifacts",
        default="",
...
def main() -> int:
    ...
    supported_variants = {"mode-strict", "missing"}
